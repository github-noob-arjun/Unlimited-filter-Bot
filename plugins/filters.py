...
@Client.on_message(filters.command(Config.ADD_FILTER_CMD) & Config.AUTH_USERS)
...
@Client.on_message(filters.command('viewfilters') & Config.AUTH_USERS)
...
@Client.on_message(filters.command(Config.DELETE_FILTER_CMD) & Config.AUTH_USERS)
...
@Client.on_message(filters.command(Config.DELETE_ALL_CMD) & Config.AUTH_USERS)
