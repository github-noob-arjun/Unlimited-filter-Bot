...
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✨ Join My Group ✨", url="https://t.me/MovieJunctionGrp2")
                ],[
                    InlineKeyboardButton("💢 Join My Channel 💢", url="https://t.me/Mj_Index")
                ]
            ]
        ),
...
@trojanz.on_message(filters.command('help') & filters.user(Config.AUTH_USERS) & filters.private)
